...
--
-- Table structure for table `informacoes_empresa`
--

DROP TABLE IF EXISTS `informacoes_empresa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `informacoes_empresa` (
  `id_informacoes_empresa` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `informacoes_empresa`
--
