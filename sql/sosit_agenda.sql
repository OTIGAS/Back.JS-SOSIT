...
CREATE TABLE `agenda` (
  ...
  `horarios_seg` json DEFAULT NULL,
  `horarios_ter` json DEFAULT NULL,
  `horarios_qua` json DEFAULT NULL,
  `horarios_qui` json DEFAULT NULL,
...
-- Dump completed on 2023-10-06 17:33:30
