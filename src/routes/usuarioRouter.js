...
router.delete(
  "/usuario/deleta",
  verificaToken,
  usuarioController.deletaUsuario
); //Deletar Usuário

router.get(
  "/usuario/listar-meu-perfil",
  verificaToken,
  usuarioController.listarMeuPerfil
); //Listar Por Token
...
router.patch(
  "/usuario/atualizar-endereco",
  verificaToken,
  usuarioController.atualizarEndereco
); //Atualizar Endereco
router.patch(
  "/usuario/atualizar-dados-bancarios",
  verificaToken,
  usuarioController.atualizarDadosBancarios
); //Atualizar Dados Bancarios
router.patch(
  "/usuario/atualizar-informacoes-empresa",
  verificaToken,
  usuarioController.atualizarInformacoesEmpresa
