            ...
            this.db.query(
              ...
              (error, response) => {
                if (error) {
                  ...
                  switch (diaSemana) {
                    case 6:
                      if (!dadosAgenda.horarios_dom) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_dom.map((horario) => {
                          horarios.push({
                      ...
                      break;
                    case 0:
                      if (!dadosAgenda.horarios_seg) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_seg.map((horario) => {
                          horarios.push({
                            inicio: horario.inicio,
                            fim: horario.fim,
                            disponivel: true,
                      ...
                      break;
                    case 1:
                      if (!dadosAgenda.horarios_ter) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_ter.map((horario) => {
                          horarios.push({
                            inicio: horario.inicio,
                            fim: horario.fim,
                            disponivel: true,
                      ...
                      break;
                    case 2:
                      if (!dadosAgenda.horarios_qua) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_qua.map((horario) => {
                          horarios.push({
                            inicio: horario.inicio,
                            fim: horario.fim,
                            disponivel: true,
                      ...
                      break;
                    case 3:
                      if (!dadosAgenda.horarios_qui) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_qui.map((horario) => {
                          horarios.push({
                            inicio: horario.inicio,
                            fim: horario.fim,
                            disponivel: true,
                      ...
                      break;
                    case 4:
                      if (!dadosAgenda.horarios_sex) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_sex.map((horario) => {
                          horarios.push({
                            inicio: horario.inicio,
                            fim: horario.fim,
                            disponivel: true,
                      ...
                      break;
                    case 5:
                      if (!dadosAgenda.horarios_sab) {
                        return resolve({
                          id_agenda: idAgenda,
                          horarios: [],
                        });
                      } else {
                        dadosAgenda.horarios_sab.map((horario) => {
                          horarios.push({
                            inicio: horario.inicio,
                            fim: horario.fim,
                            disponivel: true,
